...
def generate_launch_description():
    #moveit_config = MoveItConfigsBuilder("thor", package_name="thor_moveit_config").to_moveit_configs()
    #return generate_move_group_launch(moveit_config)
    
    # Constants for paths to different files and folders
    package_name_gazebo = 'thor_gazebo'
    package_name_moveit_config = 'thor_moveit_config'
    ...
    urdf_file_path = 'urdf/thor_classic_gazebo.xacro'
    srdf_file_path = 'config/thor.srdf'
    ...
    moveit_config = (
        MoveItConfigsBuilder("thor", package_name=package_name_moveit_config)
