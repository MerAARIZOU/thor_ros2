...
def generate_launch_description():
  ...
  package_name_description = 'thor_description'
  package_name_gazebo = 'thor_gazebo'
 
  default_robot_name = 'thor'
  gazebo_launch_file_path = 'launch'
  gazebo_models_path = 'models'
  ros_gz_bridge_config_file_path = 'config/ros_gz_bridge.yaml'
  rviz_config_file_path = 'rviz/thor_view_description.rviz'
  urdf_file_path = 'urdf/thor_urdf.xacro'
